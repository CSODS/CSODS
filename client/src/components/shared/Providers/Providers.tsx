...
export const ProjectListContext =
  createContext<IProjectDetails[]>(PROJECT_LIST);
...
export const ProjectDetailsContext =
  createContext<IProjectDetails>(DEFAULT_PROJECT);
...
export const AllTagsContext = createContext<IAllProjectTags | undefined>(
  undefined
);
