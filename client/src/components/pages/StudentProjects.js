...
//   }, []);
  ...
  return (
    <div>
      {/* header */}
      <div className='p-0 mb-5 d-flex flex-column justify-content-center'>
        ...
        <div className='fs-5 color-non-photo-blue'>
          Discover open source projects uploaded by our very own students.
        </div>
      </div>
      {/* search bar */}
      <div className='mt-5 d-flex justify-content-center align-items-center'>
        <div className='py-3 px-4 w-50 d-flex align-items-center justify-content-start border border-celeste rounded-pill bg-dark-purple'>
      ...
      <div className='mt-4'>
        <button type='button' className='btn-custom-1 rounded-pill mx-2 px-4 border-celeste'>All</button>
        <button type='button' className='btn-custom-1 rounded-pill mx-2 px-4 border-celeste'>JavaScript</button>
        <button type='button' className='btn-custom-1 rounded-pill mx-2 px-4 border-celeste'>Python</button>
        <button type='button' className='btn-custom-1 rounded-pill mx-2 px-4 border-celeste'>C#</button>
        <button type='button' className='btn-custom-1 rounded-pill mx-2 px-4 border-celeste'>C</button>
      </div>
      {/* project cards */}
      <div className='mx-5 mt-5 px-5 row row-cols-1 row-cols-md-2 g-4 d-flex justify-content-center'>
        <div className='col'>
          {/* project card */}
            ...
            <div className='card-body pt-4 ps-4 d-flex flex-row align-items-start text-light'>
              ...
              <div className='mx-3'>
                ...
                <div className='mt-3 mb-0 d-flex flex-row align-items-center'>
                  <button type='button' className='px-4 bg-raisin-black d-flex flex-row align-items-center justify-content-center btn-custom-1 rounded-4 border-celeste'>
                    {/* <img src={github_logo} alt='...' className='img-fluid'/> */}
                    GitHub
                  </button>
                  <button type='button' className='ms-auto px-4 bg-raisin-black btn-custom-1 rounded-4 border-celeste' onClick={() => handleClick(1)}>View</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='card project-card border-celeste rounded-4 bg-dark-purple translucent'>
            <div className='card-body pt-4 ps-4 d-flex flex-row align-items-start text-light'>
              ...
              <div className='mx-3'>  
                ...
                <div className='mt-3 mb-0 d-flex flex-row align-items-center'>
                  <button type='button' className='px-4 bg-raisin-black btn-custom-1 rounded-4 border-celeste'>GitHub</button>
                  <button type='button' className='ms-auto px-4 bg-raisin-black btn-custom-1 rounded-4 border-celeste' onClick={() => handleClick(2)}>View</button>
                </div>
              </div>
            </div>
          </div>
    ...
    return (
      <div className='d-flex flex-column'>
        ...
        <div className='p-0 mb-5 d-flex flex-column align-items-center justify-content-center'>
          <h1 className='fs-h1 bolder color-celeste text-shadow-m'>Project Title</h1>
        ...
        <div className='mt-5 d-flex flex-column align-items-center'>
          <h1 className='fs-h1 bolder color-non-photo-blue text-shadow-m'>Tags</h1>
          <div className='mt-4'>
