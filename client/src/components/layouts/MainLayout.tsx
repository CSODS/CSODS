        ...
        <div>
            <div className="p-0 navbar navbar-expand-lg sticky-top">    
                <div className="py-1 ps-3 container-fluid bg-light-1 translucent-80">
                    <a className="navbar-brand color-dark-2 d-flex flex-row justify-content-center align-items-center" href={ADDRESSES.LANDING_PAGE}>
                        <img src='/lucso-logo-no-bg.png' alt="CSO_LOGO" className='header-logo'/>
                        <p className='m-0 p-0 ps-2 fs-4 bolder'>
                            CSO:DS
                        </p>  
                    </a>
                    <button className="navbar-toggler bg-dark-3 color-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation">
                        <span className="navbar-toggler-icon"></span>
                    </button>
                    <div className="collapse navbar-collapse" id="navbar">
                        <div className="navbar-nav d-none d-lg-flex gap-2 position-absolute top-50 start-50 translate-middle">
                            <NavLink to={ADDRESSES.HOME} className="mx-2 header-nav-element color-dark-2">Home</NavLink>
                            <NavLink to={projectsFirstPage} className="mx-2 header-nav-element color-dark-2">Projects</NavLink>
                            <NavLink to={ADDRESSES.ABOUT} className="mx-2 header-nav-element color-dark-2">About</NavLink>
                        </div>
                        <NavLink to={ADDRESSES.SUBMIT_PROJECT} className="ms-auto me-2 px-2 py-1 nav-link d-none d-lg-flex btn btn-neutral-1 hover-lighten rounded-pill">
                            <div className="nav-link ms-2 me-1">Submit a Project</div>
                            <i className="bi bi-arrow-right-circle ms-2 me-1"></i>
