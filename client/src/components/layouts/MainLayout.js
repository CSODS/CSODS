...
export default function MainLayout() {
    return(
        <div>
            <div className="navbar navbar-expand-lg bg-body-tertiary no-padding">    
                <div className="container-fluid header-container bg-green">
                    ...
                    <div className="collapse navbar-collapse" id="navbar">
                        ...
                        <a href="/submit_project" className="nav-link d-none d-lg-flex position-absolute top-50 end-5 translate-middle-y btn-url-1">
