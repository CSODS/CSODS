...
export function Home() {
  ...
  return (
    <div className="pt-4 d-flex justify-content-center">
      <div
        className="container-md mx-3 py-3 d-flex flex-row justify-content-center bg-light-1 translucent-70 rounded-5"
        style={{ maxWidth: 1100 }}
      >
          ...
          <div className="row g-0">
            ...
            <div className="ps-md-3 col-md-6 d-flex align-items-end">
              <div className="card-body mx-0 ps-0 pb-0 align-self-end d-flex flex-column justify-content-end">
                ...
                <h5 className="card-title col-md-9 mt-1 mb-3 text-start fs-3 color-dark-2 bolder">
                ...
                <p className="card-text col-md-9 mt-1 mb-3 color-dark-1 text-start">
                  ...
                  is a digital hub for students of the Computer Science
                  Department where we foster innovation, collaboration, and
                  academic excellence in the field of computing.
                </p>
                ...
                <div className="d-flex">
                  <a
                    ...
                    className="px-3 py-2 nav-link d-flex flex-row align-items-center justify-content-center btn btn-dark-1 rounded-pill py-2"
                  >
                    <a
                      href={projectsFirstPage}
                      className="nav-link ms-3 me-1 fs-6"
                    >
                      View Projects
                    </a>
