...
export default function Contributors() {
    ...
    return (
        <div className="py-xl-4 py-lg-3 py-2 card card-frost-gradient-1 hover-shadow border-0 row-gap-3">
            {
...
function ContributorRow({ contributorName, contributorEmail, contributorRoles }: ContributorRowProps) {
    return (
        <div className="row mx-lg-4 mx-3 me-xl-5 pe-xl-5">
            <div className="col-auto p-0">
                <i className="bi bi-person-circle color-frost-midnight fs-4"/>
            </div>
            <div className="col-auto ms-2 me-auto p-0">
                <p className="m-0 contributor-card-text text-start fw-bold color-frost-light-azure">
                    {contributorName}
                </p>
                <p className="m-0 contributor-card-text text-start color-frost-pastel-gray-azure">
                    {contributorEmail}
                </p>
            </div>
            <div className="col-auto p-0">
                    ...
                    contributorRoles.map((role, index) => {
                        return (
                            <div key={`role-${index}`} className="row">
                                <p className="m-0 contributor-card-text text-center color-frost-light-azure">
                                    {role}
                                </p>
                            </div>
                        )
