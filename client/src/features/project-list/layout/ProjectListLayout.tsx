    ...
    return (
        <div className="p-0 navbar navbar-expand-lg">    
            <div className="px-md-3 px-1 py-0 container-fluid bg-dark-3 translucent-100">
                <a className="me-md-1 mx-0 navbar-brand d-flex flex-row justify-content-center align-items-center color-light-1" href={ADDRESSES.LANDING_PAGE}>
...
function SearchBar() {
  ...
  return(
    <div className="ms-1 me-auto col-md-6 col d-lg-none d-flex">
        <div className='w-100 d-flex align-items-center justify-content-center bg-light-1 translucent-30 rounded-1'>
            <input type='text' className='mx-1 my-2 w-100 fs-6 color-light-1' value={searchString} onChange={handleType} onKeyDown={handleKeyDown}/>
            <div className="px-3 h-100 d-flex justify-content-center align-items-center bg-dark-3 translucent-70 rounded-end-1">
                <i className="bi bi-search color-light-1"/>
            </div>
        </div>
    </div>
  )
