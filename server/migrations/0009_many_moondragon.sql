ALTER TABLE `refresh_tokens` RENAME TO `user_sessions`;--> statement-breakpoint
ALTER TABLE `user_sessions` RENAME COLUMN "token_id" TO "session_id";--> statement-breakpoint
